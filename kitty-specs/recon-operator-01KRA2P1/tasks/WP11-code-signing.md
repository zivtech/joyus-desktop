...
```json
"macOS": {
  "signingIdentity": "Developer ID Application: Zivtech LLC (TEAM_ID)",
...
```
APPLE_SIGNING_IDENTITY   — e.g., "Developer ID Application: Zivtech LLC (XXXXXXXXXX)"

...
owned_files:
- _private/docs/verification/wp09-governance-verification.md
- _private/docs/verification/wp09-telemetry-verification.md
- kitty-specs/001-desktop-runtime-policy-enforcement/**
- src/__tests__/governance-integration.test.ts
- src/__tests__/telemetry-integration.test.ts
- src/governance-integration.ts
- src/governance.ts
- src/telemetry-integration.ts
wp_code: WP09
---
...
**Files**: `_private/docs/verification/wp09-governance-verification.md`
...
**Files**: `_private/docs/verification/wp09-telemetry-verification.md`

...
owned_files:
- _private/docs/verification/wp10-e2e-cowork-onboarding.md
- _private/docs/verification/wp10-e2e-developer-onboarding.md
- _private/docs/verification/wp10-no-desktop-required.md
- _private/docs/verification/wp10-telemetry-report.md
- _private/docs/verification/wp10-version-propagation.md
wp_code: WP10
---
...
7. Repeat with a Partner Org user account (CEO or Dir of Ops role).

**Files**: `_private/docs/verification/wp10-e2e-cowork-onboarding.md`
...
**Files**: `_private/docs/verification/wp10-e2e-developer-onboarding.md`
...
**Files**: `_private/docs/verification/wp10-no-desktop-required.md`
...
2. Test from at least one user per org for each connector:
   ...
   - Partner Org user: (applicable connectors only)
3. Document per-connector, per-org results:
   | Connector | Zivtech | Partner Org | Notes |
   |-----------|---------|-----------|-------|
...
**Files**: `_private/docs/verification/wp10-telemetry-report.md`
...
**Files**: `_private/docs/verification/wp10-version-propagation.md`

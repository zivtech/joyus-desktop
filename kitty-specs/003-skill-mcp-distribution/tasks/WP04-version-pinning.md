...
- _private/docs/verification/wp04-version-pin-verification.md
- src/sync.ts
wp_code: WP04
---
...
3. Create `CHANGELOG.md` in the repo root with initial release notes:
   ...
   - Bundle definitions: PM, Developer, Partner Org, Full
   ```
...
**Files**: `_private/docs/verification/wp04-version-pin-verification.md`

...
- Existing verification docs: `docs/verification/desktop-app-smoke-test.md`, `_private/docs/verification/wp11-e2e-desktop-companion.md`, `docs/operations/runbook-006.md`

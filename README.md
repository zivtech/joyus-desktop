...
See [CONTRIBUTING.md](CONTRIBUTING.md) for development setup, quality gates (100% test coverage), and conventions. To report a security issue, see [SECURITY.md](SECURITY.md).
